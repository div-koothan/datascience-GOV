...
```{r, echo=FALSE}
knitr::include_graphics("R-Markdown-Aux/Basic-R-Script.png", dpi = 600)
```
...
```{r, echo=FALSE}
knitr::include_graphics("R-Markdown-Aux/R-Output-Plots.png", dpi = 800)
```

## But You Could Turn in This:

```{r, echo=FALSE}
knitr::include_graphics("R-Markdown-Aux/RMarkdown_Formatted.png", dpi = 600)
```
...
```{r, echo=FALSE}
knitr::include_graphics("R-Markdown-Aux/Better-Formatting.png", dpi = 600)
```
...
```{r, echo=FALSE}
knitr::include_graphics("R-Markdown-Aux/R-Markdown-Title.pdf", dpi = 100)
```
...
```{r, echo=FALSE}
knitr::include_graphics("R-Markdown-Aux/Choosing-R-Markdown-Document.png", dpi = 750)
```
...
```{r, echo=FALSE}
knitr::include_graphics("R-Markdown-Aux/code_chunk.png", dpi = 500)
```
...
knitr::include_graphics("R-Markdown-Aux/Napoleon.png", dpi = 600)
```


## Can add the figure a different way 

![Caption here](R-Markdown-Aux/Napoleon.png)


## Or some good photos:

```{r, fig.align='center', echo=FALSE}
knitr::include_graphics("R-Markdown-Aux/TheProfessor.png", dpi = 600)
```
